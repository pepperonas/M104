...
public class DialogChangelog {
    ...
    public List<Changelog> getChangelogs() {
        ...
        changes.add(new Changelog("0.3.2-beta", "2017-04-20",
            new ReleaseInfo("Back to Nougat (25.0.2)",
                "Fixed network notification",
                "Removed unused code",
                "Minified build",
                "Proguard enabled")));

        changes.add(new Changelog("0.3.1-beta", "2017-03-23",
            new ReleaseInfo("Migrate to Android O (26.0.0 rc1)", "Optimized images",
                "Removed LRU cache")));

        changes.add(new Changelog("0.3.0", "2017-03-17",
            new ReleaseInfo("Updated SDK tools (25.0.2)", "Fixed missing battery indicator")));

        changes.add(new Changelog("0.2.9", "2017-03-17",
        ...
        changes.add(new Changelog("0.2.8", "2017-02-19",
        ...
        changes.add(new Changelog("0.2.7", "2017-01-26",
            new ReleaseInfo("Updated support libraries (25.1.0)",
                "Updated Play Services (10.0.1)")));

        changes.add(new Changelog("0.2.6", "2016-07-24",
            new ReleaseInfo("Supported Android Nougat", "Updated support libraries (23.4.0)",
                "Updated Play Services (9.2.1)", "Fixed icons")));

        changes.add(new Changelog("0.2.5", "2016-05-03", new ReleaseInfo("Minor fixes")));

        changes.add(new Changelog("0.2.4", "2016-04-10", new ReleaseInfo("Minor fixes")));

        changes.add(
            new Changelog("0.2.3", "2016-02-20", new ReleaseInfo("Removed unnecessary callbacks")));

        changes.add(new Changelog("0.2.2", "2016-02-11",
            new ReleaseInfo("Fixed error (fast network speed)")));

        changes.add(new Changelog("0.2.1", "2016-02-11", new ReleaseInfo("Minor fixes")));

        changes.add(new Changelog("0.2.0", "2016-02-10",
        ...
        changes.add(new Changelog("0.1.8", "2016-02-05", new ReleaseInfo("Fixed premium key")));

        changes.add(new Changelog("0.1.7", "2016-01-25",
            new ReleaseInfo("Fixed animation when clipboard is wiped",
                "Fixed animation in network fragment", "Performance tweaks")));

        changes.add(new Changelog("0.1.6", "2016-01-17",
        ...
        changes.add(new Changelog("0.1.4", "2016-01-14",
            new ReleaseInfo("Added new animation for network chart",
                "Fixed verification process")));

        changes.add(new Changelog("0.1.3", "2016-01-13", new ReleaseInfo("Fixed autos-tart")));

        changes.add(new Changelog("0.1.2", "2016-01-12",
        ...
        changes.add(new Changelog("0.0.6", "2016-01-06",
