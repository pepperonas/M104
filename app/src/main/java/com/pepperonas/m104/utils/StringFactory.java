    ...
    public static CharSequence makeStatusInfo(Context ctx, int status, int plugged) {
        switch (status) {
            ...
            case BatteryManager.BATTERY_STATUS_NOT_CHARGING:
                return ctx.getString(R.string.battery_charge_not_charging);
            default:
                return ctx.getString(R.string.battery_charge_unknown);
        }
    }
    ...
    private static CharSequence plugged(Context ctx, int plugged) {
        switch (plugged) {
            ...
            case BatteryManager.BATTERY_PLUGGED_USB:
                return ctx.getString(R.string.battery_plugged_usb);
            case BatteryManager.BATTERY_PLUGGED_WIRELESS:
                return ctx.getString(R.string.battery_plugged_wireless);
            default:
