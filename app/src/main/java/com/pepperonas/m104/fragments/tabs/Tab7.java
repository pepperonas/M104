...
public class Tab7 extends Fragment {
    ...
    private static final String TAG = "Tab7";

    private static IInstalledBasicsCommunicator mInstalledBasicsCommunicator;


    public static Tab7 getInstance(FragmentRoot fragmentRoot, int i) {
    ...
    class LoaderTask extends AsyncTask<String, String, String> {
        ...
        public LoaderTask(ProgressBar progressBar) {
        ...
        protected String doInBackground(String... arg) {
            dumpData = DumpLoader.loadDump(FragmentRoot.FILE_ALARMSTS);
            return null;
        }
        ...
        protected void onPostExecute(String arg) {
            ...
            try {
                ((TextView) getActivity().findViewById(R.id.tv_root_tab_7)).setText(dumpData);
            } catch (Exception e) {
