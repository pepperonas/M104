...
public class Tab8 extends Fragment {
    ...
    private static final String TAG = "Tab8";

    private static IInstalledBasicsCommunicator mInstalledBasicsCommunicator;


    public static Tab8 getInstance(FragmentRoot fragmentRoot, int i) {
    ...
    class LoaderTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... arg) {
            dumpData = DumpLoader.loadDump(FragmentRoot.FILE_BTRY_STS);
            return null;
        }
        ...
        protected void onPostExecute(String arg) {
            ...
            try {
                ((TextView) getActivity().findViewById(R.id.tv_root_tab_8)).setText(dumpData);
            } catch (Exception e) {
