...
public class Tab6 extends Fragment {
    ...
    public static Tab6 getInstance(FragmentRoot fragmentRoot, int i) {
    ...
    class LoaderTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... arg) {
            dumpData = DumpLoader.loadDump(FragmentRoot.FILE_NWK_INFO);
            return null;
        }
        ...
        protected void onPostExecute(String arg) {
            ...
            try {
                ((TextView) getActivity().findViewById(R.id.tv_root_tab_6)).setText(dumpData);
            } catch (Exception e) {
